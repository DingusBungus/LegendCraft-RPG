...
namespace fCraft {
    ...
    public static class Config {
        ...
        static XElement DefineDefaultRanks() {
            ...
            owner.Add(new XElement(Permission.Name.ToString()));
            
            owner.Add(new XElement(Permission.ElementalBuff.ToString()));
            owner.Add(new XElement(Permission.StrengthBuff.ToString()));
            owner.Add(new XElement(Permission.FocusBuff.ToString()));

            owner.Add(new XElement(Permission.Jump.ToString()));
            owner.Add(new XElement(Permission.Sprint.ToString()));

            owner.Add(new XElement(Permission.Heal.ToString()));
            owner.Add(new XElement(Permission.Confuse.ToString()));
            owner.Add(new XElement(Permission.Poison.ToString()));
            owner.Add(new XElement(Permission.GiveMana.ToString()));
            
            owner.Add(new XElement(Permission.BodySlam.ToString()));
            owner.Add(new XElement(Permission.Earthquake.ToString()));
            owner.Add(new XElement(Permission.Fissure.ToString()));
            owner.Add(new XElement(Permission.InfernalWrath.ToString()));
            owner.Add(new XElement(Permission.SelfDestruct.ToString()));
            owner.Add(new XElement(Permission.ElementalSpear.ToString()));

...
namespace fCraft
{
    ...
    public static class PlayerEnumerable
    {
        ...
        /// <summary> Filters a collection of players, leaving only those who have the given player info bool. </summary>
        /// <param name="source"> Original collection of players. Will not get modified. </param>
        /// <param name="playerInfoType"> The Player.Info bool to use as the filter. </param>
        /// <returns> Filtered collection of players. </returns>
        [NotNull]
        public static IEnumerable<Player> CanDo([NotNull] this IEnumerable<Player> source, bool playerInfoType)
        {
            if (source == null) throw new ArgumentNullException("source");
            foreach (Player player in source)
            {

...
namespace fCraft
{
    ...
    public static class PlayerDB
    {
        ...
        const string Header = "fCraft PlayerDB | Row format: " +
                              ...
                              "LastFailedLoginIP,Points,FirstLoginDate,LastLoginDate,TotalTime," +
                              ...
                              "Password,IsOnline,BandwidthUseMode,IsHidden,LastModified,DisplayedName,Agility," +
                              "Alignment,Defence,Elemental,Focus,Luck,MagicDefence,Mana,Strength,Vitality,Wisdom,XP,Race";
        ...
        internal static void SwapPlayerInfo([NotNull] PlayerInfo p1, [NotNull] PlayerInfo p2)
        {
            ...
            lock (AddLocker)
            {
                lock (SaveLoadLocker)
                {
                    ...
                    Swap(ref p1.Points, ref p2.Points);
